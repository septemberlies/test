  ...
  <div class="select-box">
    <el-form :inline="true" :model="selectData" class="demo-form-inline">
      <el-form-item label="标题">
        <el-input v-model="selectData.title" placeholder="关键字" clearable />
      </el-form-item>
      <el-form-item
        label="详情
     "
...
export default defineComponent({
  setup() {
    ...
    const currentChaneg = (page: number) => {
    ...
    return { ...toRefs(data), currentChaneg, sizeChange, dataList, onSubmit };
  },
});
</script>
